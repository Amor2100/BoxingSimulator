...
void FinalpassShader::Draw(const RenderContext& rc, const Sprite* sprite)
{
	...
	cbFinalpass.viewPosition = rc.viewPosition;
	cbFinalpass.screenSize = rc.screenSize;
	cbFinalpass.view = rc.view;
	cbFinalpass.projection = rc.projection;
	DirectX::XMMATRIX V = DirectX::XMLoadFloat4x4(&rc.view);
	DirectX::XMMATRIX P = DirectX::XMLoadFloat4x4(&rc.projection);
	DirectX::XMStoreFloat4x4(&cbFinalpass.inverseView, DirectX::XMMatrixInverse(nullptr, V));
	DirectX::XMStoreFloat4x4(&cbFinalpass.inverseProjection, DirectX::XMMatrixInverse(nullptr, P));
