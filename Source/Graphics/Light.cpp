...
void Light::PushRenderContext(RenderContext& rc) const
{
	...
	switch (lightType)
	{
		case	LightType::Directional:
		{
			...
			rc.directionalLightData.color.x = color.x * color.w;
			rc.directionalLightData.color.y = color.y * color.w;
			rc.directionalLightData.color.z = color.z * color.w;
			rc.directionalLightData.color.w = color.w;
			break;
		}
		case	LightType::Point:
		{
			...
			rc.pointLightData[rc.pointLightCount].color.x = color.x * color.w;
			rc.pointLightData[rc.pointLightCount].color.y = color.y * color.w;
			rc.pointLightData[rc.pointLightCount].color.z = color.z * color.w;
			rc.pointLightData[rc.pointLightCount].color.w = color.w;
		...
		case	LightType::Spot:
		{
			...
			rc.spotLightData[rc.spotLightCount].color.x = color.x * color.w;
			rc.spotLightData[rc.spotLightCount].color.y = color.y * color.w;
			rc.spotLightData[rc.spotLightCount].color.z = color.z * color.w;
			rc.spotLightData[rc.spotLightCount].color.w = color.w;
